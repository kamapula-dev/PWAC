...
export class ContentGenerationService {
  ...
  async generateAppDescription(): Promise<string> {
    return this.generateContent(
      'Напиши описание приложения для казино на русском языке простыми словами. Это реклама. Описание должно подчеркнуть интерфейс и бонусы. Около 200 токенов. 3 предложения. Не добавляй свои комментарии, только описание. Начало предложения всегда разное',
      200,
      [
